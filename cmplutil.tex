...
%       10 \C 0 5 1 5 2 4 \S \m 34 -195 \C -10 10 -6 14 -2 13 \S \m 56
%       -195 \C 8 8 -6 8 -5 9 \S
%       \begin{pgfscope} \pgfsetlinewidth{2\pgflinewidth}
%       \m 53 -170 \C -6 9 -6 8 8 8 \S \m 98 -243 \C 3 7 4 7 0 7 \S \m
%       18 -110 \C 6 14 14 12 11 11 \S \m 94 -195 \C -13 13 3 24 -13 13
%       \S \m 60 -118 \C 0 15 25 16 -14 14 \S \m 16 -158 \C -1 5 0 5 0 4
%       \L 0 10 \S \m 116 -195 \C 6 6 1 7 -1 8 \S \m 60 -46 \L 0 20 \S
%       \end{pgfscope}
%       \ov 44 -78 32 32 \S \ov 44 -150 32 32 \S \re 104 -150 32 32 \S
%       \ov 29 -222 32 32 \S \ov 89 -222 32 32 \S
%     \end{sdpgf} \right]
    \qquad
    \text{(b):}\quad
    \left[ \begin{sdpgf}{0}{0}{150}{-268}{0.2pt}
...
\begin{topic}[Mathematical interpretation of feedbacks]
  ...
  rewrite rules. It was however already in~\cite{NR1} observed that 
  this model had certain problems, and in~\cite{LH:IWC} it was 
  suggested that some further refinement might be needed.
...
the latter case when time it was dropped.
